...
def extractNotes(q, img_file):

    staff_files = [
        "resources/template/staff2.png",
        "resources/template/staff.png",
        "resources/template/staff6.png",
        "resources/template/staff5.png"]
    quarter_files = [
    ...
    def extractMIDI(img_file):
        ...
        for note_group in note_groups:
            notes_array.append([note.note + " " + note.sym + " " + str(len(note_group)) for note in note_group])
